...
class DOTParser ( Parser ):
    ...
    class GraphContext(ParserRuleContext):
        ...
        def id(self):
            return self.getTypedRuleContext(DOTParser.IdContext,0)
    ...
    class StmtContext(ParserRuleContext):
        ...
        def id(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(DOTParser.IdContext)
            else:
                return self.getTypedRuleContext(DOTParser.IdContext,i)
    ...
    def id(self):
        ...
        localctx = DOTParser.IdContext(self, self._ctx, self.state)
